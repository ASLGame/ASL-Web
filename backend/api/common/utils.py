...
def dummyDB():
    ...
    new_achievement = achievement(name="Spell 10 words", type="Word", description="User has to spell 10 words", date_created=func.now(), task=10, account_stats_id=1, game_id=1)
    db.session.add(new_achievement)
    new_achievement = achievement(name="Spell 20 words", type="Word", description="User has to spell 20 words", date_created=func.now(), task=20, account_stats_id=1, game_id=1)
    db.session.add(new_achievement)
    new_achievement = achievement(name="Spell 30 words", type="Word", description="User has to spell 30 words", date_created=func.now(), task=30, account_stats_id=1, game_id=1)
    db.session.add(new_achievement)
